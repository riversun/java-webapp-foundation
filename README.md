...
###  "java-webapp-foundation" is an example project that allows you to develop a micro Web Apps and Web APIs with JSP/Servlet easily and quickly.


It is licensed under [Apache 2.0 license](https://www.apache.org/licenses/LICENSE-2.0).

# Tutorial
## Step by step tutorial with Eclipse below.

# - How to import(clone) web app project. -
### 1.comment
- comment1
- comment2
